# Support the Trace apps

NutriTrace, LiftTrace, CookTrace, and NoteTrace are free to self-host and always will be. No paid tier, no feature behind a donation, no telemetry. They're built and maintained by one person.
...
Nothing yet. This list gets updated as the fund does.
